...
function SelectTrigger(
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        // ——— SÓLIDO (igual aos inputs/cards) ———
        "flex items-center justify-between gap-2 whitespace-nowrap",
        "w-full rounded-md border border-input bg-card px-3 py-2 text-sm shadow-sm",
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        // ——— SÓLIDO (sem transparência) + mesma borda/sombra de popover/modal ———
        className={cn(
          "z-50 max-h-(--radix-select-content-available-height) min-w-[8rem] overflow-hidden",
          "rounded-md border border-input bg-card text-foreground shadow-md",
